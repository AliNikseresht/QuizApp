...
function showResult(){
    ...
    if(userScore > 3){
        let scroeTag = '<span>and congrats! 🎉 , You got <p>'+ userScore + '</p> out of <p>'+ questions.length + '</p></span>'
        scoreText.innerHTML = scroeTag
    }else if(userScore > 1){
        let scroeTag = '<span>and nice 😉 , You got <p>'+ userScore + '</p> out of <p>'+ questions.length + '</p></span>'
        scoreText.innerHTML = scroeTag
    }else{
        let scroeTag = '<span>and sorry 🫤 , You got <p>'+ userScore + '</p> out of <p>'+ questions.length + '</p></span>'
        scoreText.innerHTML = scroeTag
    }
}
